            ...
            <form action="{{ route('register') }}" method="POST">
                @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <input type="password" name="password" placeholder="Choose a password" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('password') border-red-500 @enderror" value="">
                        @error('password')
                            <div class="text-red-500 mt-2 text-sm">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="password" name="password_confirmation" id="name" placeholder="Repeat your password" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('password_confirmation') border-red-500 @enderror" value="">
